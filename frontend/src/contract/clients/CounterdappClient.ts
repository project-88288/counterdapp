...
export interface CounterdappReadOnlyInterface {
  contractAddress: string;
  getCountQuery: () => Promise<CountResponse>;
}
export class CounterdappQueryClient implements CounterdappReadOnlyInterface {
  client: LCDClient;
  contractAddress: string;
...
export interface CounterdappInterface extends CounterdappReadOnlyInterface {
  contractAddress: string;
...
export class CounterdappClient extends CounterdappQueryClient implements CounterdappInterface {
  client: LCDClient;
