...
import { CounterdappClient } from './contract/clients/CounterdappClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new CounterdappClient(lcd, connectedWallet, contractAddress('counterdapp', connectedWallet));
  }, [lcd, connectedWallet]);
